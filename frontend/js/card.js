...
//Funcion para cardar los datos de la carta
...
//Funcion para cargar datos de los usuario
function cargarUser() {
  token = localStorage.getItem("token")
  if (!token) {
    location.href = "login.html"
...
// Parte para lograr subir los comentarios
        ...
        <div class="movie-info">
          ...
          <div class="info-details">
            ...
            <div class="info-item">
              ...
              <p class="info-value">${data.movie.rating + "/10"}</p>
            </div>
            <div class="info-item">
              <img src="./imgs/genre.png" alt="" class="info-label">
              <p class="info-value">${genresString}</p>
            </div>
          </div>
    
          <!-- Contenedor para el Iframe -->
          <div class="info-item">
            <a href="${data.movie.trailer}" class="btnIframe" id="watch-trailer-btn" target="_blank">Watch Trailer</a>
